...
def config_parser():
    ...
    parser.add_argument('--sample_mode', type=str, default='uniform',
                        help='how to sample pixels from images for training:'
                             'uniform|center')
    parser.add_argument('--resize_factor', type=float, default=1.0, help='the ratio of center crop to keep')
    ...
    parser.add_argument("--lrate_sr", type=float, default=5e-4, help='learning rate for sr')
