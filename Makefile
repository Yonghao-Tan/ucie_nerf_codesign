...
test2:
	cd ./eval && \
	CUDA_VISIBLE_DEVICES=6 python eval.py --config ../configs/eval_llff_sr.txt --eval_scenes fern --chunk_height 10 --ckpt_path ../pretrained/pretraining/model_best.pth --num_source_views 8 --window_size 5 --sample_point_group_size 8 --sample_point_sparsity --sv_prune --sv_top_k 5 --use_moe --sparsity 0.5 --resize_factor 0.5 --sr --new_sr
# --q_bits 8 
test2_nosr:
	cd ./eval && \
