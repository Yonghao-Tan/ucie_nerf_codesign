...
def create_accuracy_chart():
    ...
    """
    # 数据
    categories = ['Baseline', 'w/ Direct SR', 'w/ CSU']
    values = [25, 24.3, 24.9]  # PSNR值
    ...
    ax.set_yticks([23.5, 24, 24.5, 25, 25.5])
    ...
    line_end_x = bars[2].get_x() + bars[2].get_width()  # 延伸到最后一个柱子
    ...
    for i in range(1, len(values)):
        ...
        if difference < 0:
            ...
            ax.text(text_x, text_y, f'{difference:.1f}', 
