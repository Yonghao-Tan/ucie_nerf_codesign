...
test:
	cd ./eval && \
	CUDA_VISIBLE_DEVICES=0 python eval.py --config ../configs/eval_llff.txt --num_source_views 8 --chunk_height 15 --eval_scenes fern --q_bits 8 --sparsity 0.0

test2:
	cd ./eval && \
	CUDA_VISIBLE_DEVICES=6 python eval.py --config ../configs/eval_llff_sr.txt --num_source_views 8 --resize_factor 0.5 --sr --sample_point_sparsity --window_size 5 --sv_prune --sv_top_k 5 --sample_point_group_size 8 --chunk_height 10 --eval_scenes lego --ckpt_path ../pretrained/model_share_svprune_5_sr_w8a8_s50.pth --q_bits 8 --sparsity 0.5
